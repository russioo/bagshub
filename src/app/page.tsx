    ...
    <div>
      <div style={{ marginBottom: '48px' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '16px' }}>
          Real-time data for all tokens on Bags
        </p>
      </div>
      ...
      {tokens.length === 0 ? (
        <div style={{ 
          ...
          <p style={{ fontSize: '18px', marginBottom: '8px' }}>Loading tokens from Bags API...</p>
          <p style={{ fontSize: '14px' }}>Make sure your API key is configured</p>
        </div>
      ) : (
        <div style={{
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ borderBottom: '1px solid var(--border)', background: 'var(--bg-card)' }}>
                ...
                <th style={{ padding: '14px 20px', textAlign: 'right', fontSize: '12px', fontWeight: 500, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Market Cap</th>
              </tr>
            </thead>
            <tbody>
              {tokens.map((token: BagsToken, i: number) => (
                ...
                >
                  ...
                  <td style={{ padding: '16px 20px', textAlign: 'right', fontFamily: 'monospace', fontSize: '14px' }}>
                  ...
                  <td style={{ padding: '16px 20px', textAlign: 'right', fontFamily: 'monospace', fontSize: '14px', color: 'var(--text-muted)' }}>
